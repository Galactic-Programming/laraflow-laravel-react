        ...
        <section id='features' className='py-12 sm:py-16'>
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                ...
                <div className='mb-8 space-y-4 sm:mb-12'>
                    <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>Powerful Features for Your Productivity</h2>
                    <p className='text-muted-foreground text-xl'>
                        Explore the tools designed to help you manage projects efficiently, stay organized, and achieve your goals
                        with ease.
                    </p>
