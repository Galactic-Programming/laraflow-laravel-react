        ...
        <section className='bg-muted py-12 sm:py-16'>
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                ...
                <div className='mb-8 space-y-4 text-center sm:mb-12'>
                    ...
                    <p className='text-muted-foreground text-xl'>Connect with the apps you already use to streamline your workflow.</p>
                </div>
                    ...
                    <CardContent className='px-14'>
                        <div className='flex flex-wrap items-center justify-center gap-x-12 gap-y-8 text-muted-foreground'>
                            {integrations.map((item, index) => (
                                <div key={index} className='flex items-center gap-2 transition-colors hover:text-foreground' title={item.name}>
                                    {item.icon}
