        ...
        >
            ...
            <div className="mt-6">
                <div className="relative mb-4 text-center">
                    <div className="absolute inset-0 top-1/2 h-px w-full border-t-2 border-black dark:border-white" />
                    <span className="relative bg-white px-4 text-xs font-bold uppercase tracking-wide text-gray-700 dark:bg-black dark:text-gray-300">
                        Or continue with
                    </span>
                </div>
